        ...
        <div className="flex text-center">
          <button
            ...
            className={`flex-1 py-4  text-lg transition-all duration-300 relative ${
              activeTab === 'login'
                ? 'font-formula-bold border-b-2 border-f1-purple text-black bg-white'
                : 'font-formula-regular border-b-2 border-transparent text-black bg-gray-100 hover:border-f1-purple/20'
            }`}
          >
            Login
          </button>
